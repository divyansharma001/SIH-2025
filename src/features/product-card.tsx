...
export const ProductCard = ({ product, index, isAnalyzed = false, isSafe = true, analysisResult }: ProductCardProps) => {
  ...
  return (
    <div className="plasmo-bg-white plasmo-rounded-xl plasmo-p-4 plasmo-border plasmo-border-gray-200 plasmo-shadow-sm hover:plasmo-shadow-md plasmo-transition-all plasmo-duration-200">
